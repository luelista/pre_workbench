...
from PyQt5.QtWidgets import QWidget, QApplication, QMenu, QSizePolicy, QMessageBox, QAction
...
from pre_workbench.guihelper import setClipboardText, str_ellipsis, GlobalEvents
